...
<head>
    ...
    <title><g:layoutTitle default="Spring boot"/></title>
                            ...
                            <li>
                                <a>
                                    <form action="/logout" method="get">
                                        <button name="logout" value="logout" formaction="/logout" class="log"><i
                                                class="icon-key icon"></i> Log Out</button>
                                    </form>
                                </a>
                            </li>
                        </ul>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="">
                                                <a href="table_static_responsive.html"
                                                   class="nav-link ">Responsive Tables</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="dropdown-submenu ">
