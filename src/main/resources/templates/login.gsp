        ...
        <div class="col-md-6 login-container bs-reset">
            <div class="login-content">
                ...
                <form action="/login" class="login-form" method="post">
                    ...
                    <g:if test="${session.getAttribute("SPRING_SECURITY_LAST_EXCEPTION")}">
                        <span>${session.getAttribute("SPRING_SECURITY_LAST_EXCEPTION").message}</span>
                    </g:if>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="registration">
                                <a href="javascript:;" id="registration" class="registration">Registration</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <form class="registration-form" action="/user/register" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-6">
                                <input class="form-control form-control-solid placeholder-no-fix" type="text"
                                       autocomplete="off" placeholder="Fame Name" name="email"/></div>
                    ...
                    <div class="form-actions">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}"/>
                        <button type="button" id="back-btn-registration" class="btn grey btn-default">Back</button>
                        <button type="submit" class="btn blue btn-success uppercase pull-right">Submit</button>
                    </div>
                </form>
